define('user/widget/view/account_security/select_change_mobile', function(require, exports, module) {

/**
 * Created by wll on 15/8/11.
 */
...
var select =function(){
    ...
    _select.prototype.setHeight = function(h){
        this.pop.height(h);
    }
    return new _select();
}
