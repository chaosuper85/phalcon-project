define('common/module/upload/uploader', function(require, exports, module) {
	...
	$.fn.AjaxFileUpload = function(options) {
		...
		function onComplete (e) {
			var $iframe  = $(e.target),
				...
				response = util.delHtmlTag(doc.body.innerHTML),
                status = 0;//0正确1异常
			if (response) {
                try{
                    ...
                    _alert('您上传的文件格式过大或其他未知错误！详情请联系箱典典官方客服400-969-6790');
                    status = 1;
                }
			} else {
				response = {};
