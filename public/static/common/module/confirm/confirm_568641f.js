...
with (locals || {}) { (function(){ 
 buf.push('<div class="confirm-title">确认信息</div>\n<div id="confirm">\n    请点击确定，继续执行!\n</div>\n<div class="confirm-pop-btn confirm-btn ">\n	<a href="javascript:;" class="user-btn" id="cancelBtn">取消</a>\n    <a href="javascript:;" class="user-btn" id="confirmBtn">确定</a>\n</div>'); })();
} 
return buf.join('');
} catch (err) {
