define('order/widget/view/order_complete/addressBox', function(require, exports, module) {
...
function AddressBox(_option){
	...
	$(CONST.SCOPE).on('click', '.del-AddressBtn', function(event) {
		...
		for (i = 0; i < list.length; i++) {
			if(list[i].$scope.attr('data-item') == item){
				list.splice(i, 1);
				break
			}
		};
