<div id="order-new">
    <div class="breadcrumb">
        <ol>
            <li><a href="/freight/order/choose">发起订单</a></li>
            <li>></li>
            <li class="active">发起出口装货订单</li>
        </ol>
    </div>
    ...
    <div class="chanzhuang mod">
        ...
        <div class="content">
            <div class="item clearfix">
                ...
                <div class="item-message clearfix">
                    <div class="error-message hidden"><i class="icon-warn"></i>装货联系单必须上传</div>
                    <div class="right-message hidden"><i class="icon-right"></i></div>
                </div>
            </div>
        </div>
        ...
        <div class="content ">
            <div class="item clearfix">
                ...
                <div class="item-message clearfix">
                    ...
                    <div class="ajax-notice hidden"><i class="icon-warn"></i>您输入的提单号已存在</div>
                    <div class="right-message hidden"><i class="icon-right"></i></div>
                </div>
            </div>
            <div class="item clearfix">
