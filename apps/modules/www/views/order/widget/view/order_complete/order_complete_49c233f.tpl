...
{%$box_type_list = $data.data.box_type_list%}
	...
	<div class="ship_info">
		...
		<div class="content">
			...
			<div class="item clearfix">
				...
				<div class="item-content">
					<input type="text" value="" id="ship_yard" name="ship_yard" placeholder="请输入运抵堆场" />
				</div>
				<div class="item-message clearfix">
...
{%script type="text/javascript"%}
	require('order/widget/view/order_complete/order_complete').init('{%$data.data.order_fregiht_id%}',{%json_encode($box_type_list)%});
{%/script%}
