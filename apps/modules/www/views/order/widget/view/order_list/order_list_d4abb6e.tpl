...
<div id="order-list" class="user-content">
	<table class="nav">
		<tr class="nav">
			<td class="{%$pageType[0]%}"><a href="/order/list">全部订单<span>({%$data.data.total_count.0%})</span></a></td>
			<td class="cut"></td>
			<td class="{%$pageType[1]%}"><a href="/order/list?status=1">待确认<span>({%$data.data.total_count.1%})</span></a></td>
			<td class="cut"></td>
			<td class="{%$pageType[3]%}"><a href="/order/list?status=3">待提箱<span>({%$data.data.total_count.3%})</span></a></td>
			<td class="cut"></td>
			...
			<td class="cut"></td>
			<td class="{%$pageType[7]%}"><a href="/order/list?status=7">交易成功<span>({%$data.data.total_count.7%})</span></a></td>
			<td class="cut"></td>
			<td class="{%$pageType[8]%}"><a href="/order/list?status=8">交易关闭<span>({%$data.data.total_count.8%})</span></a></td>
			<td class="cut"></td>
		</tr>
	</table>
