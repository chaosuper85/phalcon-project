...
class AddressConfirmValidation extends Validation
{
    public function initialize()
    {
        $this->add('orderid', new PresenceOf(array(
            'message' => 'The orderid is required'
        )));

        $this->add('address_info', new PresenceOf(array(
            'message' => 'The address_info is required'
        )));
