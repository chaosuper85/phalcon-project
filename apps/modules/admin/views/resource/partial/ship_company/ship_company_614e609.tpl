...
<ul class="table-filter clearfix">
	...
	<li>
		...
		<input type="text" class="filter-input" placeholder="船公司"/>
	</li>
	<li>
...
{%script type="text/javascript"%}
	require('resource/partial/ship_company/ship_company').init({%json_encode($param)%});
{%/script%}