...
abstract class Log_Abstract {
    ...
    private $_basic_fields = array(
        self::BF_APP_NAME    => array(array('Library\Log\Log_Abstract', 'get_app_name'),    false, array()),
        self::BF_BACK_TRACE  => array(array('Library\Log\Log_Abstract', '_bf_back_trace'),  false, array()),
        self::BF_CODE_BLOCK  => array(array('Library\Log\Log_Abstract', '_bf_code_block'),  false, array()),
        self::BF_CODE_LINE   => array(array('Library\Log\Log_Abstract', '_bf_code_line'),   false, array()),
        self::BF_EXEC_TIME   => array(array('Library\Log\Log_Abstract', '_bf_exec_time'),   false, array()),
        self::BF_LOG_ID      => array(array('Library\Log\Log_Abstract', '_bf_log_id'),      true,  array()),
        self::BF_LOG_LEVEL   => array(array('Library\Log\Log_Abstract', '_bf_log_level'),   false, array()),
        self::BF_MEMORY      => array(array('Library\Log\Log_Abstract', '_bf_memory'),      false, array()),
        self::BF_METHOD      => array(array('Library\Log\Log_Abstract', '_bf_method'),      true,  array()),
        self::BF_PROCESS_ID  => array(array('Library\Log\Log_Abstract', '_bf_pid'),         true,  array()),
        self::BF_REQ_IP      => array(array('Library\Log\Log_Abstract', '_bf_req_ip'),      true,  array()),
        self::BF_REQ_VARS    => array(array('Library\Log\Log_Abstract', '_bf_req_vars'),    true,  array()),
        self::BF_SERVER_HOST => array(array('Library\Log\Log_Abstract', '_bf_server_host'), true,  array()),
        self::BF_SERVER_IP   => array(array('Library\Log\Log_Abstract', '_bf_server_ip'),   true,  array()),
        self::BF_SESSION     => array(array('Library\Log\Log_Abstract', '_bf_sessions'),    true,  array()),
        self::BF_STEP_TIME   => array(array('Library\Log\Log_Abstract', '_bf_step_time'),   false, array()),
        self::BF_TIMESTAMP   => array(array('Library\Log\Log_Abstract', '_bf_timestamp'),   false, array()),
        self::BF_URI         => array(array('Library\Log\Log_Abstract', '_bf_uri'),         true,  array()),
    );
