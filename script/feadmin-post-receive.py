...
def send_email(subject , newcommit):
	gitUrl = "http://123.59.59.233:7990/projects/XDDWEB/repos/frontend_admin/commits/"
...
if branch == 'refs/heads/staging':
	pt=subprocess.Popen(" unset GIT_DIR && sh /home/work/fe_test/yk/phpweb/script/feadmin_deploy.sh  ",shell=True,stdout=subprocess.PIPE)
